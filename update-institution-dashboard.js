...
const dashboardPath = 'frontend/src/screens/InstitutionDashboardScreen.js';
...
try {
  ...
  console.log('✅ InstitutionDashboardScreen.js updated successfully!');
  console.log('   - Added active status toggle');
  console.log('   - Improved UI with sections');
  console.log('   - Added emojis for better UX');
